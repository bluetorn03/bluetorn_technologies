...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteLayout-CL_625_D.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "mt-6 flex flex-col gap-1 overflow-y-auto pr-1 pb-8",
					children: [nav.map((n, i) => {
						const isExpanded = !!mobileExpanded[i];
						if (!n.mega) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: n.to ?? "/",
							onClick: () => setMobile(false),
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: `flex w-full items-center justify-between rounded-2xl px-4 py-3 text-lg font-medium text-white/90 transition-colors hover:bg-white/5 ${isExpanded ? "bg-white/5 text-teal" : ""}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: n.label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: `h-5 w-5 opacity-70 transition-transform duration-300 ${isExpanded ? "rotate-180 text-teal" : ""}` })]
								...
								children: isExpanded && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "my-1 ml-4 border-l border-teal/30 pl-4 pr-2 space-y-4 py-2",
										children: n.mega.map((sec) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mb-2 text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-teal",
											children: sec.heading
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
											className: "space-y-1",
											children: sec.items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: it.desc
												})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4 shrink-0 text-white/40 transition-transform group-hover:text-teal group-hover:-translate-y-0.5 group-hover:translate-x-0.5" })]
											}) }, it.title))
										})] }, sec.heading))
									})
								})
...
function Footer() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		className: "relative z-10 overflow-hidden border-t-2 border-teal/25 bg-ink text-white shadow-[0_-30px_80px_-40px_rgba(56,224,208,0.35)]",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				"aria-hidden": true,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "text-[0.7rem] font-semibold uppercase tracking-wider text-teal",
											children: "Business Contact"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
											href: "mailto:info@bluetorn.com",
											className: "flex items-center gap-2 hover:text-teal",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: "h-4 w-4 text-teal shrink-0" }), " info@bluetorn.com"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
											href: "tel:+917788996579",
											className: "flex items-center gap-2 hover:text-teal",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "h-4 w-4 text-teal shrink-0" }), " +91 77889 96579"]
										})
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
											...
											className: "flex items-center gap-2 hover:text-teal",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: "h-4 w-4 text-teal shrink-0" }), " contact@bluetorn.com"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
											href: "tel:+917788996549",
											className: "flex items-center gap-2 hover:text-teal",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "h-4 w-4 text-teal shrink-0" }), " +91 7788996549"]
										})
									]
								})
							]
