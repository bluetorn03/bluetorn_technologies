...
//#region src/routes/industries.tsx?tsr-split=component
function IndustriesIndex() {
	return /* @__PURE__ */ jsxs(SiteLayout, { children: [
		/* @__PURE__ */ jsxs("section", {
			className: "relative bg-ink text-white",
			children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 grid-fade opacity-40" }), /* @__PURE__ */ jsxs("div", {
							...
							children: /* @__PURE__ */ jsxs(Link, {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: ["Explore industry ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" })]
									})
								]
							})
						}, ind.slug);
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					children: /* @__PURE__ */ jsxs(MagneticButton, {
						to: "/contact",
						variant: "primary",
						children: ["Start a Project ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					})
				})]
			})
		})
