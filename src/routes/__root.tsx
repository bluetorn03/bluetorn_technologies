...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/g6ogmSw7YUZY2CygbkUroHcS71K2/social-images/social-1784415752474-BluetornTextLogo.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/g6ogmSw7YUZY2CygbkUroHcS71K2/social-images/social-1784415752474-BluetornTextLogo.webp" },
    ],
    links: [
